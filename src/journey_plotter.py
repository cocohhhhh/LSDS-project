...
class JourneyPlotter:
    ...
    def __print_journey_human_readable(self, journey: list, stops_info: pd.DataFrame, confidence: float) -> None:
    ...
    def plot_journeys(self, journeys: list, source_stop_id: str, destination_stop_id: str, stops_info: pd.DataFrame) -> None: 
        """
        Plot the journeys.
